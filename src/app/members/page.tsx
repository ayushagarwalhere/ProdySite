...
type Member = {
  ...
  category: string;
  year: number;
  title: string; // alchemical title
};

const POKEMON_SPRITES = (id: number) =>
  `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${id}.png`;

// Alchemical titles mapped to posts
...
const ALL_MEMBERS: Member[] = [
  { year: 4, category: "Final Year", name: "Sourabh Awasthi", post: "President", pokemon: "Charizard", pokemonImage: POKEMON_SPRITES(6), memberImage: "/members/final/Sourabh.png", title: ALCHEMICAL_TITLE["President"] },
  ...
  { year: 4, category: "Final Year", name: "Ayan Chordia", post: "Finance Head", pokemon: "Snorlax", pokemonImage: POKEMON_SPRITES(143), memberImage: "/members/final/ayan.png", title: ALCHEMICAL_TITLE["Finance Head"] },
  ...
  { year: 4, category: "Final Year", name: "Rishika Sharma", post: "Creative Head", pokemon: "Leafeon", pokemonImage: POKEMON_SPRITES(470), memberImage: "/members/final/rishika.png", title: ALCHEMICAL_TITLE["Creative Head"] },
  ...
  { year: 3, category: "Coordinator", name: "Akshit Saini", post: "Convener (Event)", pokemon: "Machamp", pokemonImage: POKEMON_SPRITES(68), memberImage: "/members/third/akshitsaini.png", title: ALCHEMICAL_TITLE["Convener (Event)"] },
  ...
  { year: 3, category: "Coordinator", name: "Akshit Pathania", post: "Technical Head", pokemon: "Magnezone", pokemonImage: POKEMON_SPRITES(462), memberImage: "/members/third/akshitpathania.png", title: ALCHEMICAL_TITLE["Technical Head"] },
  ...
  { year: 3, category: "Coordinator", name: "Kanishk Singh", post: "Media & Marketing Head", pokemon: "Absol", pokemonImage: POKEMON_SPRITES(359), memberImage: "/members/third/kanishk.png", title: ALCHEMICAL_TITLE["Media & Marketing Head"] },
  ...
  { year: 2, category: "Executive", name: "Ayush Agarwal", post: "Executive Member", pokemon: "Bulbasaur", pokemonImage: POKEMON_SPRITES(1), memberImage: "/members/second/ayushagarwal.png", title: ALCHEMICAL_TITLE["Executive Member"] },
  ...
  { year: 2, category: "Executive", name: "Saksham Shandilya", post: "Executive Member", pokemon: "Charmander", pokemonImage: POKEMON_SPRITES(4), memberImage: "/members/second/sakshamshandiliya.png", title: ALCHEMICAL_TITLE["Executive Member"] },
  ...
  { year: 2, category: "Executive", name: "Biyanka Sharma", post: "Executive Member", pokemon: "Vulpix", pokemonImage: POKEMON_SPRITES(37), memberImage: "/members/second/biyanka.png", title: ALCHEMICAL_TITLE["Executive Member"] },
  ...
  { year: 2, category: "Executive", name: "Arpit Phogat", post: "Executive Member", pokemon: "Beldum", pokemonImage: POKEMON_SPRITES(374), memberImage: "/members/second/arpit.png", title: ALCHEMICAL_TITLE["Executive Member"] },
      ...
      <style>{`
        ...
        * { cursor: none !important; }
        ...
        .page-title {
          ...
          margin: 0;
          line-height: 1;
          text-shadow: 0 0 40px rgba(231,186,128,0.2);
        }
        .page-rule {
        ...
        .year-tab {
          ...
          border: none;
          border-right: 1px solid rgba(180,124,60,0.2);
        ...
        .member-card-wrap:hover .member-card-front,
        .member-card-wrap:hover .member-card-back {
          border-color: rgba(231,186,128,0.7);
          box-shadow:
            0 0 20px rgba(255,120,0,0.25),
            0 0 40px rgba(255,80,0,0.12),
            inset 0 0 20px rgba(231,186,128,0.04);
        }
        ...
        .member-img-overlay {
          ...
          background: linear-gradient(180deg, transparent 40%, #0e0b06 100%);
        }
        .member-card-label {
        ...
        .card-back-glow {
          position: absolute; inset: 0;
          background: radial-gradient(ellipse at 50% 30%, rgba(180,124,60,0.12) 0%, transparent 70%);
          pointer-events: none;
        }
        .pokemon-wrap {
          display: flex;
        ...
        .back-divider {
          ...
          background: linear-gradient(to right, transparent, rgba(180,124,60,0.5), transparent);
          margin: 0.5rem auto;
        }
        .back-pokemon {
          font-family: 'DM Sans', sans-serif;
        ...
        @media (max-width: 768px) {
          .members-page { padding: 80px 16px 100px; }
          .members-scroll { padding: 1rem 0.5rem; gap: 1rem; }
          .year-tab { padding: 0.5rem 1rem; font-size: 0.75rem; }
        }
      `}</style>
