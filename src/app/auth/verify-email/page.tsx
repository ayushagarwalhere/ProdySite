    ...
    <>
      <style>{`
        ...
        .auth-btn {
          ...
          background: #b47c3c; border: 1px solid #b47c3c; border-radius: 4px;
          color: #0a0703; font-size: 0.875rem; font-family: 'DM Sans', sans-serif;
        ...
        .auth-btn-outline {
          ...
          background: transparent; border: 1px solid rgba(180,124,60,0.3); border-radius: 4px;
          color: #b47c3c; font-size: 0.875rem; font-family: 'DM Sans', sans-serif;
          font-weight: 500; text-transform: uppercase; letter-spacing: 0.18em;
      ...
      <div style={{ minHeight:"100vh", width:"100%", background:"#0a0a0a", display:"flex", alignItems:"center", justifyContent:"center", padding:"80px 24px 40px", boxSizing:"border-box" }}>
        ...
        <div style={{ position:"relative", zIndex:1, width:"100%", maxWidth:460, borderRadius:12, border:"1px solid rgba(180,124,60,0.2)", padding:"2.5rem", background:"linear-gradient(160deg,#0e0b06 0%,#110d07 100%)", display:"flex", flexDirection:"column", alignItems:"center", textAlign:"center" }}>
          ...
          {status === "success" && (
            <div style={{ marginBottom:"1.5rem", width:64, height:64, borderRadius:"50%", border:"1px solid rgba(180,124,60,0.4)", background:"rgba(180,124,60,0.08)", display:"flex", alignItems:"center", justifyContent:"center" }}>
          ...
          <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"0.9rem", color:"rgba(180,124,60,0.65)", lineHeight:1.7, marginBottom:"2rem" }}>
            ...
            {status === "idle"    && "Verifying your email address…"}
          </p>
          ...
          {status === "loading" && (
            <div style={{ display:"flex", gap:6, alignItems:"center" }}>
              {[0,1,2].map(i => (
                <span key={i} style={{ width:6, height:6, borderRadius:"50%", background:"#b47c3c", opacity:0.7, animation:`bounce 1.2s ease-in-out ${i*0.2}s infinite`, display:"inline-block" }} />
              ))}
            </div>
          )}
